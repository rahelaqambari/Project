...
createRoot(document.getElementById('root')).render(
  <StrictMode>
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus ipsa ratione quo inventore provident, error eligendi ullam quae recusandae fuga voluptates numquam quasi vitae velit ea, dolorum minus totam dolores?</p>
    <App />
  </StrictMode>,
)
