...
function Sample() {
  ...
  return (
    <div className='w-full min-h-screen flex items-center justify-center flex-col gap-3 '>
      ...
      <button className='font-bold py-2 px-4 text-2xl focus:-transition-3 duration-150 rounded-md bg-blue-600 text-white' onClick={hndelClick}>Create Acount</button>
